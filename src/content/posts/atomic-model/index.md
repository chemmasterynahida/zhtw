...
其實呢，化學的本質，就是研究原子們是如何彼此建立聯系的。  
而當我們把量子物理應用到這些「原子之間的關系」時——  
...
他認為帶負電的電子，分布在一個帶**正電的球體**中，就像布丁裡的葡萄干那樣散落其中。  
![葡萄干布丁模型](pudding.jfif "plum pudding")  
他稱之為——**「葡萄干布丁模型（Plum Pudding Model）」**。  
...
* $\theta$ —— 散射角  
* $b$ —— **沖量參數（impact parameter）**，即 α 粒子軌跡與原子核中心的最近橫向距離  

---

就這樣，從熒光屏上那幾道微弱的閃光開始，盧瑟福揭開了物質結構的全新面貌——  
原子的真正「心髒」，也就是**原子核**，終於在光影之間，向人類顯現。  
...
![散射幾何關系](scattering-geometry.png "Geometry of scattering")
...
根據能量與角動量的關系 $E = \frac{1}{2}L\omega$，波爾得出了一個極為優美的結果：  
$$L=mvr=n\frac{h}{2\pi}$$  

這裡的 $L$ 是**角動量**——這，正是波爾的**量子假設**。  
而將角動量與離散軌道聯系起來的靈感，最初來自於**約翰·W·尼科爾森**（John W. Nicholson）。  
...
根據德布羅意關系式 $\lambda = h/p$，電子若繞原子核運行，駐波條件應為：  
